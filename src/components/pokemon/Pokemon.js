...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    // Urls de información e los pokemones
    const pokemonUrl = `https://pokeapi.co/api/v2/pokemon/${pokemonIndex}/`;
    const pokemonSpeciesUrl = `https://pokeapi.co/api/v2/pokemon-species/${pokemonIndex}/`;

    // Get información obtenida de los pokemones
    ...
    // Conversiones de peso, altura y eso.
    const height =
    ...
    // Esto es la información de los pokemones,  o sea, la descripción y su leyenda si tiene.
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Rango de captura:</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-left">{this.state.catchRate}%</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-right">Posibilidad de género:</h6>
                  </div>
                  <div className="col-6">
                    <div class="progress">
                      <div
              ...
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Pasos para eclosión:</h6>
                  </div>
                  <div className="col-6">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Puntos de esfuerzo:</h6>
                  </div>
                  <div className="col-6">
